...
function ContactSection() {
  return (
    <section className="flex flex-col items-center mt-80 max-md:mt-32">
      ...
      <p className="mt-14 text-3xl font-light text-center text-white max-w-[864px] w-auto max-md:mt-10 max-md:max-w-full max-md:text-xl max-sm:mt-4 max-sm:text-base">
      ...
      <div className="flex gap-5 mt-20 max-w-full text-lg font-medium tracking-wider text-center w-[782px] max-md:flex-wrap max-md:mt-10">
        ...
        >
          <div className="justify-center items-center  py-5 border border-white border-solid max-md:px-4 max-sm:px-3 max-sm:py-4 hover:bg-white hover:text-black hover:border  border-solid ">
            Ring us on Skype
          </div>
        </a>
        <a
        ...
        >
          <div className="justify-center items-center text-black  py-5 border border-white border-solid max-md:px-4 max-sm:px-3 max-sm:py-4 hover:bg-black hover:text-white hover:border border-white border-solid ">
          Contact Us
          </div>
