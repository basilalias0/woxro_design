...
function ContributionSection() {
  return (
    <section className="flex flex-col items-center mt-52 max-md:mt-24">
      <h2 className="text-5xl font-extralight font-roboto leading-10 text-white capitalize max-md:text-4xl">
        Our Contribution
      </h2>
      <p className="mt-10 text-lg text-center font-poppins font-extralight text-white max-w-[1142px] w-auto max-md:max-w-full">
      ...
      <div className="mt-32 max-w-full w-[883px] max-md:px-2.5 max-md:mt-6 max-sm:flex max-sm:flex-col max-sm:-mb-1 max-sm:grow-0">
