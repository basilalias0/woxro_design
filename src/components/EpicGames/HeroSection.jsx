...
function HeroSection() {
  return (
    <section className="flex flex-col items-center self-center mt-14 w-full max-w-[1415px] max-md:mt-10 max-md:max-w-full">
      ...
      <img
        loading="lazy"
        src="https://cdn.builder.io/api/v1/image/assets/TEMP/05f9398a64a7add819fe5867505dd6b38705948e23baaa3ab99fb7f1d8aeaab5?apiKey=5c025788d7dd4263bf85a4f7bfa9ed1a&"
